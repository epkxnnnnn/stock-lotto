        ...
        <tbody>
          {payoutRates.map((rate) => (
            <tr key={rate.type} className="hover:bg-[var(--brand-primary)]/[0.03] transition-colors">
              <td className="px-5 py-3.5 text-sm font-semibold text-[var(--text-primary)] border-b border-white/[0.03] last:[&:last-child]:border-b-0">
                {rate.type}
              </td>
              <td className="px-5 py-3.5 font-mono text-[var(--brand-light)] font-bold border-b border-white/[0.03]">
                {rate.rate}
              </td>
              <td className="px-5 py-3.5 text-xs text-[var(--text-muted)] border-b border-white/[0.03]">
                {rate.description}
              </td>
            </tr>
          ))}
